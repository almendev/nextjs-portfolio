...
const Skill = ({ name, x, y }: Props): JSX.Element => {
  return (
    <motion.div
      className="absolute flex items-center justify-center px-4 py-2 rounded-full font-semibold bg-dark
      text-light shadow-dark shadow-md cursor-pointer md:text-sm md:py-1.5 md:px-3 sm:bg-transparent sm:shadow-none sm:text-dark"
  ...
  return (
    <>
      ...
      <div className="relative flex items-center justify-center w-full h-screen rounded-full bg-circularLight lg:h-[80vh] sm:h-[60vh] xs:h-[50vh] lg:bg-circularLightLg md:bg-circularLightMd sm:bg-circularLightSm">
        <motion.div
          className="flex items-center w-16 h-16 justify-center rounded-full font-semibold bg-dark text-light shadow-dark shadow-md cursor-pointer
        ...
        <Skill name="Git" x="0vw" y="-28vw" />
        <Skill name="Tailwind CSS" x="-20vw" y="-22vw" />
        <Skill name="Bootstrap" x="12vw" y="28vw" />
